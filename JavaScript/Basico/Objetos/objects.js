...
const person3 = Person('John', 25, 80.5, true);
const person4 = Person('Mary', 25, 80.5, false);
...
const person5 = OtherPerson('John', 25, 80.5, true);
const person6 = OtherPerson('Mary', 25, 80.5, false);
...
const person7 = AnotherPerson('John', 25, 80.5, true);
const person8 = AnotherPerson('Mary', 25, 80.5, false);
const personWithError = AnotherPerson(5, 'José', 80.5, false); // Aqui, estamos tentando atribuir um valor do tipo string para a propriedade age.
